...
def main(simulado):
    ...
    print("Saida de D CURSOS RAW")
    print(d_cursos_raw)
   
    # d_cursos = d_cursos_raw + colunas de ['simulado_ano', 'simulado_id', 'simulado']
    # d_simulados = Lista de simulados únicos extraida de d_cursos_raw
    ...
    # Filtrando os cursos pelo simulado desejado na execução
    ...
    d_escolas = pd.read_sql(f"select * from {SCHEMA}.d_escolas", con=engine)
